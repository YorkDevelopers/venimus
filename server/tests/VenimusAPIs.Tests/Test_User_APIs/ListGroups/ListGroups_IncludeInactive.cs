...
namespace VenimusAPIs.Tests.ListGroups
{
    ...
    public class ListGroups_IncludeInactive : BaseTest
    {
        ...
        public ListGroups_IncludeInactive(Fixture fixture) : base(fixture)
        {
        }
        ...
        {
            Response = await Fixture.APIClient.GetAsync($"api/Groups?IncludeInActiveGroups=true");
        ...
        private async Task ThenTheListOfGroupsIsReturned()
        {
            ...
            Assert.Equal(4, actualGroups.Length);
            ...
            AssertGroup(_expectedInactiveGroup, actualGroups);
        }

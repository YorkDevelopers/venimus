...
namespace VenimusAPIs.Tests.ViewGroupEvents
{
    ...
    public class ViewPastEvents_Success : BaseTest
    {
        ...
        public ViewPastEvents_Success(Fixture fixture) : base(fixture)
        {
        }
        ...
        private async Task WhenICallTheAPI()
        {
            ...
            Response = await Fixture.APIClient.GetAsync($"api/Groups/{_group.Slug}/Events?includePastEvents=true&includeFutureEvents=false");

            Response.EnsureSuccessStatusCode();
        }

        private async Task ThenThePastEventsForTheGroupAreReturned()
        {
            ...
            for (int i = 0; i < 10; i++)
            {
                AssertEvent(events, _pastEvents[i]);
            }
        }
